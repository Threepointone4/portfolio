...
So we use **VAE**. This model compressed image into small dimension, which gives only important value which adds value. This will reduce our inputs which will reduce the computation.
